...
$categories_query = "
    ...
    AND (categories.name LIKE '%BS%' OR categories.name LIKE '%GS%')
    ORDER BY categories.name ASC
";
$categories = $selected_tournament ? $conn->query($categories_query) : [];
...
$where_clauses[] = "(categories.name LIKE '%BS%' OR categories.name LIKE '%GS%')"; // Only Singles categories

$where_sql = $where_clauses ? 'WHERE ' . implode(' AND ', $where_clauses) : '';

// Query for Singles rankings
$query = "
    SELECT 
