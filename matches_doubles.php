...
$query = "
    SELECT m.id, t.name AS tournament_name, c.name AS category_name, 
           ...
           m.stage, m.match_date, m.match_time,
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <?= htmlspecialchars($row['team1_player1_name'] ?? 'N/A') ?>,
                            <?= htmlspecialchars($row['team1_player2_name'] ?? 'N/A') ?>
                        </td>
                        <td>
                            <?= htmlspecialchars($row['team2_player1_name'] ?? 'N/A') ?>,
                            <?= htmlspecialchars($row['team2_player2_name'] ?? 'N/A') ?>
                        </td>
